    ...
    .setAction(async function (taskArguments, hre_) {
        ...
        for (const contractName of contractsToSet) {
            ...
            for (const name of namesInFinder) {
                ...
                const currentlySetAddress = await finder.interfacesImplemented(identifierHex);
                if (currentlySetAddress !== contract.options.address) {
                    const txn = await finder.changeImplementationAddress(identifierHex, contract.options.address);
                    console.log(
